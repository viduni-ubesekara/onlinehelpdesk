...
<% //catch the details come from url in useraccount page
    ...
    <div class="container01">
        ...
        <form id="registration-form" action="deletestudent" method="post">
            ...
            <input type="text" id="id" name="nic" value="<%= nic %>" readonly>
            
            <label for="dob">Date Of Birth</label>
            <input type="date" id="date" name="dob" value="<%= dob %>" readonly>
            ...
            <input type="text" id="address" name="faculty" value="<%= faculty %>" readonly>
