...
<% //catch the details come from url in useraccount page
    ...
    <div class="container01">
        <h1>Delete Ticket</h1>
        <form id="registration-form" action="deleteticket" method="post">
            ...
            <input type="text" id="id" name="inquiry" value="<%= inquiry %>" readonly>
            
            <label for="dob">Sub Inquiry</label>
            <input type="text" id="date" name="subinquiry" value="<%= subinquiry %>" readonly>
           
 		    <label for="address">Subject</label>
            <input type="text" id="address" name="subject" value="<%= subject %>" readonly>
