...
<div class="container01">
        ...
        <form id="registration-form" action="insertstudent" method="post">
			...
			<input type="text" id="nic" name="nic" required placeholder="Ex: 2000XXXXXXXX" pattern="\d{12}" title="Enter a valid NIC (Ex: 2000XXXXXXXX)" oninput="validateNIC()">

			<div id="validationnicMessage"></div>
			
			 <label for="date">Date Of Birth</label>
            <input type="date" id="date" name="dob" required placeholder="Date Of Birth">
...
function validateNIC() {
    ...
    var validationMessage = document.getElementById("validationnicMessage");
    var pattern = /^\d{12}$/;

    if (pattern.test(nicInput.value)) {
        validationMessage.innerHTML = "Valid NIC";
        validationMessage.style.color = "green";
    } else {
        validationMessage.innerHTML = "Invalid NIC. Please enter a valid NIC (Ex: 2000XXXXXXXX).";
        validationMessage.style.color = "red";
    }
}
</script>
