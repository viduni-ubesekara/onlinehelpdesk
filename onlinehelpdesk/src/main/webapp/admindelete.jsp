...
<title>Delete Admin Profile</title>
<style>
        body {
...
<% //catch the details come from url in useraccount page
    ...
    <div class="container01">
        ...
        <form id="registration-form" action="admindelete" method="post">
        	<label for="id">Registration ID</label>
            <input type="text" id="id" name="adminid" value="<%= adminid %>" readonly>
            
            
            <label for="name">Name</label>
            <input type="text" id="name" name="name" value="<%= name %>" readonly>
            
			<label for="id">Admin Type</label>
            <input type="text" id="id" name="admintype" value="<%= admintype %>" readonly>
