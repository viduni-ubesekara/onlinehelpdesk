...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            <div class="user mt-5">
                ...
                <table class="table">
                    ...
                    <c:set var="adminid" value="${cus.adminid}"/><!-- this line internally call to the get ID method in student class -->
                   	<c:set var="name" value="${cus.name}"/>
					<c:set var="admintype" value="${cus.admintype}"/>
                ...
                <br>
                <c:url value="adminupdate.jsp" var="adminupdate"><!-- navigate to the updatestudent page and show these details -->
				<c:param name="adminid" value="${adminid}"/><!-- ID is the variable name of set tag above -->
				
				<c:param name="name" value="${name}"/>
				<c:param name="admintype" value="${admintype}"/>
        ...
        <div class="col-md-4">
            <div class="side-section mt-5">
                <img src="images/adminpro.png" alt="Profile Picture" class="profile-picture ">
                <h3 class="mt-3">Actions</h3>
                <form action="ticket" method="post">
			
			<input type="submit" class="btn btn-success btn-block" name="submit" value="View Ticket Details" >
			</form>
                 <br>
              <form action="feedback" method="post">
			
			<input type="submit" class="btn btn-success btn-block" name="submit" value="View Feedback Details" ><br>
			</form>
			<a href="admininsert.jsp" class="btn btn-info btn-block">Add Admin</a>
                <a href="${adminupdate}" class="btn btn-info btn-block">Edit Profile</a>
    ...
    <c:url value="admindelete.jsp" var="admindelete">
				...
				<c:param name="password" value="${password}"/>
    				 ...
    				 <a href="${admindelete}" name="delete" class="btn btn-danger btn-block">Delete Account</a>
