...
<% //catch the details come from url in useraccount page
    ...
    <div class="container01">
        <h1>Update Ticket</h1>
        <form id="registration-form" action="updateticket" method="post">
        
        	<label for="id">Ticket ID</label>
            <input type="text" id="id" name="ticketid" value="<%= ticketid %>" readonly>
			...
			<label for="id">Inquiry Type</label>
            <input type="text" id="id" name="inquiry" value="<%= inquiry %>" required>
            
            <label for="dob">Sub Inquiry</label>
            <input type="text" id="date" name="subinquiry" value="<%= subinquiry %>" required>
           
 		    <label for="address">Subject</label>
            <input type="text" id="address" name="subject" value="<%= subject %>" required>
