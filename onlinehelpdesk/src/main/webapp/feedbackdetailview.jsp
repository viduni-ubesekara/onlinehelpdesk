    ...
    <div class="row">
        <div class="col-md-8">
            <div class="user mt-5">
                ...
                <br>
                <c:url value="feedbackupdate.jsp" var="feedbackupdate"><!-- navigate to the updatestudent page and show these details -->
        ...
        <div class="col-md-4">
            <div class="side-section mt-5">
                ...
                <a href="${feedbackupdate}" class="btn btn-info btn-block">Edit Feedback</a>
                
    <c:url value="feedbackdelete.jsp" var="feedbackdelete">
				<c:param name="feedbackid" value="${feedbackid}"/><!-- ID is the variable name of set tag above -->
				<c:param name="name" value="${name}"/>
				<c:param name="email" value="${email}"/>
				<c:param name="studentid" value="${studentid}"/>
				...
				<c:param name="rating" value="${rating}"/>
    				 ...
    				 <a href="${feedbackdelete}" name="delete" class="btn btn-danger btn-block">Delete</a>
