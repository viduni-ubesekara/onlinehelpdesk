    ...
    <div class="row">
        <div class="col-md-8">
            <div class="user mt-5">
                ...
                <table class="table">
                    <c:forEach var="cus" items="${stDetails}">
                    <c:set var="id" value="${cus.id}"/><!-- this line internally call to the get ID method in student class -->
                ...
                <br>
                <c:url value="stprofileupdate.jsp" var="stupdate"><!-- navigate to the updatestudent page and show these details -->
				<c:param name="id" value="${id}"/><!-- ID is the variable name of set tag above -->
        ...
        <div class="col-md-4">
            <div class="side-section mt-5">
                <img src="images/login01.png" alt="Profile Picture" class="profile-picture img-fluid">
                <h3 class="mt-3">Actions</h3>
                <a href="ticketsearch.jsp" class="btn btn-success btn-block">Ticket Raise Details</a>
                 <a href="feedbacksearch.jsp" class="btn btn-success btn-block">Feedback Details</a>
               
                <a href="${stupdate}" class="btn btn-info btn-block">Edit Profile</a>
                
    <c:url value="stprofiledelete.jsp" var="stdelete">
				<c:param name="id" value="${id}"/><!-- ID is the variable name of set tag above -->
				<c:param name="studentid" value="${studentid}"/>
				<c:param name="name" value="${name}"/>
				<c:param name="nic" value="${nic}"/>
				...
				<c:param name="password" value="${password}"/>
    				 ...
    				 <a href="${stdelete}" name="delete" class="btn btn-danger btn-block">Delete Account</a>
